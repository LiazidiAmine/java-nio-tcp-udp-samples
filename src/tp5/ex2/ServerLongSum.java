...
public class ServerLongSum {
	...
	private static HashMap<SocketAddress,HashMap<Long,LongSum>> map = new HashMap<>();
	...
	public void newLongSum(SocketAddress dst, long sessionId, long idPosOper, long totalOper, long opValue){
		...
		LongSum LS = new LongSum(idPosOper,totalOper,opValue);
		if(!map.containsKey(dst)){
...
class LongSum {
	...
	LongSum(long posOper, long totalOper, long opValue){
		this.RES = opValue;
